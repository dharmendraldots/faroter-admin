			...
			<div class="panel panel-primary filterable">
				<div class="panel-heading">
					<div class="pull-right">
						<a href="archive-list.php" class="btn btn-default btn-xs exportCsv"><span class="glyphicon glyphicon-briefcase"></span> Archive</a>
				...
				<div class="table-responsive" style="padding: 15px;">
					...
					<table id="exampleTable" class="table table-striped table-sm">
						...
						foreach ($documents as $document) {
							if ($document->exists()) {
								if(!isset($document->data()['payment_status']) || $document->data()['payment_status'] == 0 || $document->data()['payment_status'] == ""){
									$sno++;
