...
if(isset($_REQUEST['action'])){
	...
	if($action == "reset_password_request"){
		...
		if(isset($_REQUEST['email']) && $_REQUEST['email'] != ""){		
			...
			$response = $fuser->forgetPassword($email);
			...
			if($response){
				...
				<div class="alert alert-success" id="success-alert">
				  ...
				  <strong>Success! </strong> Reset link successfully sent to your email
				</div>';
			}
			else{
				$sucMsg = '
...
<body>
    <div id="logreg-forms">
        ...
        <form class="form-signin" accept="#" method="post">
            ...
            <button class="btn btn-success btn-block" type="submit" name="action" value="reset_password_request"><i class="fas fa-sign-in-alt"></i>
                Request</button>
